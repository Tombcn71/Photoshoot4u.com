...
export const PrivacyPolicy = () => {
  return (
    <>
      <div>
        <article className="prose m-12 text-black lg:prose-xl">
          ...
          <p>
            3. Data use: We use your data to: Provide the app and maintain
            manage your account inform you about updates and new features
            Analyze and improve your use of the app Generate your main photos{" "}
          </p>
          <p>
            4. Data sharing: We do not share your personal data with third
            parties, unless: This is required by law. We need your consent is
            for providing the app or managing your account{" "}
          </p>
          <p>
            5. Data transfer: Your data may be transferred to and stored in
            countries outside the European Economic Area (EEA). We take
            appropriate measures to ensure that your data are protected no
          ...
          <p>
            9. Contact: For questions or comments about our privacy policy,
